...
const Header = () => {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-1/2 pb-18 sm:pb-0 h-[3.5rem] w-full rounded-none border-white backdrop-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sn:h-[3.25rem] sm:w-[36rem] sm:rounded-full"
